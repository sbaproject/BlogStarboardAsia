 ...
 * @since 1.0.0
 */
class Start_Magazine_Heading_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
class Start_Magazine_Message_Control extends WP_Customize_Control {
 ...
 */
class Start_Magazine_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'start-magazine' );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'start-magazine-customize-controls' );
...
class Start_Magazine_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Start_Magazine_Upsell_Section extends WP_Customize_Section {
